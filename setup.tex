...
% pages for the six tables of an environment. A table is scaled down (aspect
% ratio kept) whenever its natural height would exceed
...
% trailing Mean +- Std row). In draft mode (\draftfigurestrue) the data is
% not typeset: a placeholder keeping the caption and label is emitted instead,
% since these tables are very slow to compile.
