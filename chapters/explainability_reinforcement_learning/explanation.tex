...
Explainability is not regarded as a binary property but as a continuum that evolves with the development of scientific knowledge \cite{Siegel_Craver_2024, zednik2019solving}.

Accordingly, the opacity of a system should be interpreted as an epistemic limitation reflecting the current state of knowledge rather than as an intrinsic property of the system itself.
This view is consistent with the methodological commitments of scientific inquiry.
Scientific progress is driven by the continuous refinement of theories and analytical methods that provide progressively deeper accounts of observed phenomena.
Consequently, explainability should be regarded as a matter of degree, increasing as the understanding of a system improves.
...
\begin{itemize}
    ...
    \item \textbf{Intrinsic explainability:} In this approach, it is argued that \gls{nn} inherently contain mechanisms that can be explained.
...
The substitutive view has produced valuable results, particularly when interpretability is prioritized over the raw predictive performance of \gls{dl} models \cite{rudin2019stop}.
However, this manuscript adopts \MechanisticHypothesisName \cite{Siegel_Craver_2024, zednik2019solving}, stated below.
...
Under this hypothesis, the opacity of an \gls{ai} system reflects a limitation of current knowledge and analytical tools rather than an intrinsic property of the system, so the ``black box'' framing of \gls{nn} is not adopted as an ontological claim.
