...
Finally, we introduce the concept of explainability methods and describe the properties that characterize explanations in the context of \gls{xai}.
...
So far, these disciplines have not converged on a unified definition of explanation that can be directly applied to \gls{xai}.
...
More precisely, \gls{xai} emerged as a response to the success of \gls{dl} models.
These models achieve high performance through connectionist architectures based on deep \glspl{nn}.
...
\begin{itemize}
    ...
    Under this assumption, \gls{xai} consists of replacing as much of the \gls{dl} system as possible with alternative \gls{ai} methods.
