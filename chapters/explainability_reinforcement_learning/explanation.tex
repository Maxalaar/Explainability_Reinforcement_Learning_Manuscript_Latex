...
This work adopts the perspective of \MechanisticHypothesisName formalized in Hypothesis~\ref{hyp:concept} \cite{Siegel_Craver_2024, zednik2019solving}.
Within this framework, explainability is not regarded as a binary property but as a continuum that evolves with the development of scientific knowledge.
...
Scientific progress is driven by the continuous refinement of theories and analytical methods that provide progressively deeper mechanistic accounts of observed phenomena.
...
Every system results from a sequence of causal computations.
Because the rules governing these interactions are mechanical, the behavior of the system can be explained.
If a system cannot be explained, this reflects a limitation of knowledge rather than an intrinsic property of the system.
\end{hypothesis}
...
According to the \MechanisticHypothesisName adopted in this manuscript, we consider that any system can be explained.
