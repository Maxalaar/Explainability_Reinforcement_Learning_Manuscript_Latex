...
In this setting, the problem is formulated as a supervised learning task, where the initial deep \gls{rl} policy is used to label each observation with the action it selects, such as the observation from the Atari game ``Pong'' shown in Figure~\ref{fig:policy_approximation_observation}.
