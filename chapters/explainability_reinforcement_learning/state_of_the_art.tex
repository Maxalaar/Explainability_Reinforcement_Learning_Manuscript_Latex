...
The corresponding family of methods relies on the \textit{use of the \gls{ls} for counterfactual generation}.
...
This family of methods uses generative models to build counterfactuals from the \gls{lr} of the observation \cite{bond2021deep, olson2021counterfactual}.
...
The fidelity of the generated observations to the real game can then be assessed through user studies \cite{olson2021counterfactual}.

Figure~\ref{fig:counterfactual_example} illustrates this approach on the Atari game \textit{Space Invaders} \cite{olson2021counterfactual}.
In the original observation (Figure~\ref{fig:counterfactual_example_original}) the agent selects ``LEFT'', whereas in the counterfactual observation (Figure~\ref{fig:counterfactual_example_counterfactual}) it selects ``RIGHT\_FIRE''.
