...
In Figure~\ref{fig:saliency_map_heatmap}, both panels correspond to the same observation of the Atari game ``\BreakoutName'', with panel~(a) obtained by observation perturbation and panel~(b) by observation gradient analysis.
...
Figure~\ref{fig:counterfactual_example} illustrates this approach on the Atari game \textit{\SpaceInvadersName} \cite{olson2021counterfactual}.
