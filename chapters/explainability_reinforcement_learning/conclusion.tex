...
Second, from a practical perspective, explanations of the learning process have limited interest.
...
Replacing a deep model with a simpler one therefore risks losing precisely the complexity that makes deep \gls{rl} effective.
...
From this perspective, the \gls{nn} should not necessarily be regarded as an black box, but as a complex representation whose apparent opacity may instead reflect the limitations of current analysis tools.
