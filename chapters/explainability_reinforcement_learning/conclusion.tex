...
From this perspective, the neural network should not be regarded as an inherently opaque black box, but rather as a complex representation whose apparent opacity mainly reflects the current limitations of our analysis tools (Hypothesis~\ref{hyp:mechanistic}).
