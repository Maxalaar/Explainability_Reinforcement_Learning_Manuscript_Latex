...
&= \mathbb{E}\Big[r_1 + \gamma \, V_\pi(s_2, o_2)\Big]
\end{aligned}
\]
...
\begin{aligned}
V_\pi(s, o) 
&= \mathbb{E}\Big[r_1 + \gamma \, V_\pi(s_2, o_2)\Big] \\[4pt]
...
The function \(Q_\pi\) can be related to \(V_\pi\) by recognizing that, after taking action \(a\) in state \(s\), the remaining return from the next state \(s'\) with observation \(o'\) is precisely \(V_\pi(s', o')\).
This yields:
\[
\begin{aligned}
Q_\pi(s, a) 
