...
The first one we examine in detail is the state-value function.  
...
This function is called the state-action value function \(Q_\pi : \mathcal{S} \times \mathcal{O} \times \mathcal{A} \to \mathbb{R}\).
...
The practical interest of a fully rigorous definition is limited here.  
Our aim is simply to provide the reader with an intuition of what reinforcement learning ultimately seeks to achieve.
