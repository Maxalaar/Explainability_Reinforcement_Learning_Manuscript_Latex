...
\begin{enumerate}
    \item Problems are modeled using Markov Decision Processes.
    \item The notion of policy, which formalizes the agent's behavior.
    \item The interaction between the agent and the environment is characterized through trajectories.
    \item Policies are evaluated using value functions.
...
The goal of this subsection is to introduce the notations and formalisms as they are used in modern \gls{rl} practice.  
...
Several formalisms can be used to describe a \gls{mdp}.
