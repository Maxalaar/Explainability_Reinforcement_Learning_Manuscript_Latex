...
Modern reinforcement learning mainly arises from the meeting of three strands: trial-and-error learning, optimal control, and temporal-difference learning.  
Each of these domains provided a different perspective on the problem of adaptation, but their combination progressively led to the theoretical and algorithmic framework used today.  
...
The second strand comes from optimal control.  
...
In order to more precisely formalize sequential decision-making, this work led to the development of Markov Decision Processes (MDPs).  
MDPs model a system in which an agent observes a state, selects an action, receives a reward, and transitions to a new state according to probabilistic dynamics.  
...
The MDP framework remains today the standard mathematical formulation used to model most reinforcement learning problems.
...
The third strand is that of temporal-difference learning.  
This approach appears as a conceptual bridge between interaction-based learning and methods from optimal control.  
Its central idea is to learn to estimate the value of a state by gradually correcting a prediction using another prediction observed at a later time step.  
...
The fusion of these three strands became fully explicit in the late 1980s with the introduction of algorithms such as Q-learning.  
