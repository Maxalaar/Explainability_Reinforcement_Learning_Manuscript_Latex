...
To answer this question, we first clarified what an explanation is.
Building on this framework, we identified the concepts and sources of explanation.
Regarding the subject of explanation, we distinguish two levels: a single decision and the agent's strategy.
For the source of explanation, we identify three possibilities: policies, trajectories, and value functions.
