...
Building on this frame, we proposed a taxonomy that accounts for the specificities of \gls{rl} and used it to review the state of the art.
This review led to three main observations.
First, none of the reviewed methods explains the learning process itself.
Second, there are no unified metrics for evaluating explanations.
Third, the field remains dominated by substitutive approaches, which replace the \gls{nn} with a simpler model.
...
The \RepresentationConvergenceHypothesisName states that these concepts reflect the task rather than a particular network.
