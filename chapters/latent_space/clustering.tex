...
This is shown schematically in Figure~\ref{fig:latent_clusters}, where the points represent \gls{lr} associated with concepts A, B, and C, and the ellipses indicate the approximate extent of each group and highlight their geometric separation.
...
A classical clustering algorithm is then applied to the set $\mathcal{Z}$ of \gls{lr} to identify groups of similar \gls{lr}.
