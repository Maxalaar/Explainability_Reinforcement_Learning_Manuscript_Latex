...
This suggests that the model does not merely learn statistical associations from the training data, but instead develops a structured representation of the underlying environment in which the data are generated.
...
This binary perspective can be overly restrictive, as concepts may be represented in a more continuous or graded manner, with varying degrees of presence.
