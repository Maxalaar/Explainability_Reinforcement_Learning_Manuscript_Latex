...
They include probing, interpretable directions, sparse autoencoders, and clustering, all of which build upon the \ConceptHypothesisName introduced in Section~\ref{sec:concept_hypothesis}.
Each family approaches the analysis of \gls{lr} from a different angle.
However, they share a common goal of understanding how \gls{lr} are structured and what information they contain.
