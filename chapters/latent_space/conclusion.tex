...
These include probing, interpretable directions, sparse autoencoders, and clustering, all of which build upon the \ConceptHypothesisName introduced in Section~\ref{sec:concept_hypothesis}.
