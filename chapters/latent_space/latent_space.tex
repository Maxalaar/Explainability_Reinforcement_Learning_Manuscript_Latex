...
\begin{itemize}
    \item Section~\ref{sec:concept_hypothesis} introduces the working hypothesis that underlies much of the research on \gls{ls} analysis, which we refer to as the concept hypothesis (Hypothesis~\ref{hyp:concept}).
