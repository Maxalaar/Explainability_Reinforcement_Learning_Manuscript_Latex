...
\begin{itemize}
    \item Section~\ref{sec:concept_hypothesis} introduces the working hypothesis that underlies much of the research on \gls{ls} analysis, which we refer to as the concept hypothesis.
    \item Section~\ref{sec:probing} presents probing methods for identifying and extracting concepts from \gls{lr}.
    \item Section~\ref{sec:direction} reviews semantic direction-based approaches.
    \item Section~\ref{sec:sparse_autoencoder} discusses sparse autoencoders.
    \item Section~\ref{sec:clustering} covers clustering-based approaches.
    \item Section~\ref{sec:latent_space_conclusion} provides a comparative synthesis of these methods and discusses the open questions that remain.
\end{itemize}
