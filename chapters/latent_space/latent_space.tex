...
The collection of these \gls{lr} learned throughout the network is referred to as a \gls{ls}.
...
Retrieval-augmented generation systems index and query knowledge bases through \gls{lr} \cite{lewis2021retrievalaugmentedgenerationknowledgeintensivenlp}.
...
A major objective is to understand how information is organized within these spaces, which concepts are encoded, and how these \gls{lr} influence model behavior.

The remainder of this chapter is organized as follows:
\begin{itemize}
    \item Section~\ref{sec:concept_hypothesis} introduces the hypothesis that underlies much of the research on \gls{ls} analysis, which we refer to as the \ConceptHypothesisName.
    \item Sections~\ref{sec:probing}, \ref{sec:directions}, \ref{sec:superposition}, and \ref{sec:clustering} examine four families of \gls{ls} analysis methods, respectively based on probing, interpretable directions, feature superposition, and clustering.
...
\input{chapters/latent_space/directions.tex}
\input{chapters/latent_space/superposition.tex}
