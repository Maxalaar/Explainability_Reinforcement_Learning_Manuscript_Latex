...
A \gls{nn} does not directly map $x$ to $y$, as illustrated in Figure~\ref{fig:general_architecture_multilayer_perceptron}, it computes a sequence of intermediate activations across hidden layers.
...
Neural networks generalize by performing abstraction.
