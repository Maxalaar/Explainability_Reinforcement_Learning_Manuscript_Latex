...
For the \SuperpositionHypothesisName, this provides an explanation for the entanglement observed when analyzing \gls{ls}.
...
Probing (Section~\ref{sec:probing}), interpretable directions (Section~\ref{sec:direction}), and \gls{sae} all rest on a shared assumption that the \gls{cs} can be recovered through linear decompositions of \gls{lr}.
