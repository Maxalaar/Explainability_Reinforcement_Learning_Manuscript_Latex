...
Only a restricted subset of concepts admit a linear representation, and even these directions are often entangled with multiple semantic concepts.
...
So far, all the methods described, including probing, interpretable directions, and the \SuperpositionHypothesisName, rely on a common assumption.
The \gls{cs} can be recovered from \gls{lr} through linear decomposition.
...
The following section explores an alternative approach that does not rely on this constraint.