...
If $\bar{\ell}{\text{test}} \approx \bar{\ell}{\text{train}}$, this indicates that the training procedure has successfully produced a \gls{nn} that generalizes well beyond the training data \cite{Kawaguchi_2022}.
The resulting model can therefore be considered suitable for the task for which it was trained.
