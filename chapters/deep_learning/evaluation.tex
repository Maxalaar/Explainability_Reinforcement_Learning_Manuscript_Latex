...
If $\bar{\ell}_{\text{test}} \approx \bar{\ell}_{\text{train}}$, this indicates that the model generalizes well beyond the training data \cite{Kawaguchi_2022}.
...
The collection of these representations is referred as the \gls{ls}.
The next chapter is devoted to the study of these \gls{ls}s.
