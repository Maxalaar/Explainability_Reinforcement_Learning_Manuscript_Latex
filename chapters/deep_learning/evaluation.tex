...
\begin{equation}
\bar{\ell}_{\text{train}} = \frac{1}{|\mathcal{D}_{\text{train}}|} \sum_{(x^{(i)}, y^{(i)}) \in \mathcal{D}_{\text{train}}} \fullLoss{\theta}{i}.
\label{eq:train_loss}
\end{equation}
...
\begin{equation}
\bar{\ell}_{\text{test}} = \frac{1}{|\mathcal{D}_{\text{test}}|} \sum_{(x^{(i)}, y^{(i)}) \in \mathcal{D}_{\text{test}}} \fullLoss{\theta}{i}.
\label{eq:test_loss}
\end{equation}
