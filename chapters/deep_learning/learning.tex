...
\end{equation}
For conciseness, the per-example loss on example $i$, viewed as a function of the parameters $\theta$, is denoted $\loss{\theta}{i} = \fullLoss{\theta}{i}$ throughout the remainder of this section.
