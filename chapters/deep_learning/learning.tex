...
Since these quantities are functions of several variables, we rely on the Jacobian matrix, the generalization of the derivative.
...
Despite the lack of theoretical guarantees of convergence to a global optimum in this setting, the simple procedure of random initialization followed by iterative gradient-based updates is sufficient in practice to train complex \gls{nn}.
This empirical success is often attributed to the expressive power of \gls{nn}, even though a complete theoretical understanding of this phenomenon remains an open question.