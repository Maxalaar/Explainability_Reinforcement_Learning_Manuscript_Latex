...
The input layer has no preceding layer, as its neurons directly encode the components of the input vector $x$.
...
The precise relationship between depth and function complexity remains primarily supported by empirical observations rather than formal theoretical justification \cite{goodfellow2016deep}.
