...
All the essential mechanisms of \gls{dl} are present in it, making it a particularly suitable framework for introducing key concepts.
...
Finally, it concludes with a general description of the neural network as a whole.
...
A common interpretation is that each layer acts as a processing step, so that more complex target functions require more such steps to be well approximated, although this interpretation remains grounded in empirical observation rather than formal theoretical justification \cite{goodfellow2016deep}.
