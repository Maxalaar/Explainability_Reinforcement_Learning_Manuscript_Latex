...
We therefore begin by examining the artificial neuron, the fundamental computational unit underlying the \gls{mlp}.
...
However, this interpretation is based on experimental findings rather than a theoretical justification.
