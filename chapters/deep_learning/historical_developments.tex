...
In parallel, research also turned to architectures tailored to the structure of the data being processed, rather than relying on a single generic model for every input type.
\gls{cnn}s were introduced in 1989 to process images, using local, weight-shared filters that exploit the spatial structure of pixel grids \cite{lecun1989backpropagation}.
...
This architecture underlies \gls{llm}.
