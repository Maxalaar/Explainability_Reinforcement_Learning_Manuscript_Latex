...
This distributed form of information processing is key to their versatility, enabling them to revolutionize an increasing number of domains.

Among the fields transformed by \gls{dl} is the main subject of this manuscript, \gls{rl}.
...
However, for long interactions or complex environments, these observations are not enough to infer the agent's strategy.
