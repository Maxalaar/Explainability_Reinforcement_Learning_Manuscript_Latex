...
This type of approach relies on artificial \glspl{nn} to automate an increasing number of tasks \cite{goodfellow2016deep}.
...
Due to their connectionist nature, \gls{nn} that model the agent's policy are not directly interpretable.
...
However, a particular emphasis is placed on the mechanistic approach to explainability, which we refer to as \gls{me} (Definition~\ref{def:mechanistic_explainability}).
