...
This manuscript brings together the contributions developed throughout the thesis.
It is therefore written with the reviewers in mind while remaining as accessible as possible to readers.
...
The manuscript is organized into a sequence of chapters, with each chapter falling into one of these three categories:
\begin{itemize}
