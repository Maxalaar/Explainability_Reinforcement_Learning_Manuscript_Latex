...
The position of an observation in the \gls{ls} thus reflects the stage of the game it belongs to, suggesting a correspondence between the geometry of the \gls{ls} and the semantic properties of game states.
