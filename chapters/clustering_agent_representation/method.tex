...
The second describes how these policies are trained to match the original policy as closely as possible.
...
First, the surrogate policy must faithfully reproduce the original policy so that its explanations remain relevant to the target policy.
