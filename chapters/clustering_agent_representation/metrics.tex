...
We introduce the \BehaviorReconstructionName metric to assess whether $\SurrogatePolicy{}$ faithfully reproduces the behavior of $\OriginalPolicy$.
...
We denote by $g_{\OriginalPolicy}^{i}$ the return obtained by the original policy in episode $i$, and by $g_{\SurrogatePolicy{j}}^{i}$ the return obtained by surrogate policy $\SurrogatePolicy{j}$ in episode $i$.
