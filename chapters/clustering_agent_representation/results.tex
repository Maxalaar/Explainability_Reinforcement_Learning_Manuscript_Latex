...
\input{figures/clustering_agent_representation/illustration_paper.tex}

Figure~\ref{fig:illustration_paper} previews the kind of explanation produced by \gls{car}: a two-dimensional projection of the \gls{ls} of a surrogate policy trained on Space Invaders, together with the resulting clusters and their corresponding observations.
