...
These results are consistent with the \RepresentationConvergenceHypothesisName and suggest that the \gls{ls} may capture high-level concepts that are relevant for analyzing agent behavior.