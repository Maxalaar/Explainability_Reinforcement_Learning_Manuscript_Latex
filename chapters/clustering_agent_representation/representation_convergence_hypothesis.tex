...
This hypothesis provides a criterion for evaluating concept extraction methods.
If independently trained models develop common concepts for a given task, an effective extraction method should recover these concepts consistently across models.
Such consistency provides evidence that the extracted concepts capture meaningful structures rather than model-specific artifacts.
It also gives a stronger justification for studying these concepts: if the concepts discovered in one model are consistently recovered across different training runs, they are more likely to reflect properties of the task rather than arbitrary features.
