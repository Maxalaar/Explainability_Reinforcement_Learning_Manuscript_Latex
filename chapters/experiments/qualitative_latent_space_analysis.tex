...
For each environment, a second clustering, obtained at a different layer and a different number of clusters, is also examined to illustrate how the semantic content of the partition changes with these two parameters.
Since both the layer and $K$ differ between the two clusterings, the comparisons below are descriptive rather than controlled studies of $K$ alone.
