...
\newcommand{\qualitativeClusterImageScale}{0.13}
...
% A cluster shown with two example screenshots, always kept on the same line.
\newcommand{\qualitativeClusterTwo}[3]{%
    \begin{minipage}[t]{\dimexpr 2\qualitativeClusterImageWidth+\qualitativeClusterImageGap\relax}
        ...
        \small #3
    \end{minipage}\hspace{\qualitativeClusterGap}%
}

% A cluster shown with a single example screenshot.
\newcommand{\qualitativeClusterOne}[2]{%
    \begin{minipage}[t]{\qualitativeClusterImageWidth}
        \centering
        \includegraphics[scale=\qualitativeClusterImageScale]{#1}\par
        \footnotesize #2
    \end{minipage}\hspace{\qualitativeClusterGap}%
}
