...
This checkpoint can then be loaded by the subsequent stages.
...
PyTorch Lightning provides a simple interface for supervised training while remaining compatible with PyTorch.
