...
Table~\ref{tab} summarizes the libraries used throughout the pipeline.
...
The \gls{car} implementation is organized as a pipeline of five stages, illustrated in Figure~\ref{fig:car_pipeline}.
...
The following subsections describe the purpose and implementation of each stage, as well as the libraries used.
...
PyTorch is the standard deep learning frameworks and is widely used for developing and training \gls{nn}.
It provides GPU acceleration and supports a wide range of \gls{nn} architectures.
