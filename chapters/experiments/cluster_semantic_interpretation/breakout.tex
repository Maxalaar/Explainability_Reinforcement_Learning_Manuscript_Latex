...
At layer 6b (Figure~\ref{fig:qualitative_breakout}), the partition again isolates situations in which the ball has passed behind the wall (cluster E).
It also identifies the digging of a tunnel through the left side of the wall (cluster C).
Finally, it distinguishes different paddle positions at the beginning of the episode (clusters D, F, and G).
