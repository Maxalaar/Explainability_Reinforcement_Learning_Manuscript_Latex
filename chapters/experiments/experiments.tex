...
\begin{itemize}
    ...
    \item Section~\ref{sec:experiments_clustering_quality} provides a quantitative analysis of the latent representations using the \gls{cu}, \gls{as}, and \gls{acu} metrics.
...
\input{chapters/experiments/policy_performance_and_surrogate_fidelity.tex}
\input{chapters/experiments/clustering_quality.tex}
\input{chapters/experiments/cluster_semantic_interpretation.tex}
