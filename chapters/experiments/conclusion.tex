...
Across the six environments, the \gls{cu} frequently exceeds $0.5$, indicating that independently trained policies can develop similarly structured latent representations \cite{amezquita2020orchestrating}.
