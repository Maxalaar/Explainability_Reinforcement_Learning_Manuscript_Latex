\begin{figure}[t]
    ...
    \caption{\gls{cu}, \gls{as}, and \gls{acu} with respect to the number of clusters, for each of the six environments, for the layer that maximizes the average \gls{acu} in that environment (see Sections~\ref{ssec:latent_space_analysis_breakout}--\ref{ssec:latent_space_analysis_surround} for the specific layer and average values of each environment).}
