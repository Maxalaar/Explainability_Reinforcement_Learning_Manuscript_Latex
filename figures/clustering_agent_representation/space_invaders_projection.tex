...
\begin{figure}[t]
    ...
    \caption{Two-dimensional projection of the \gls{ls} embeddings of a surrogate policy trained on \SpaceInvadersName, together with the \gls{car} clusters and their corresponding observations.}
