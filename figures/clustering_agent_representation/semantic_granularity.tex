\begin{figure}[t]
    ...
    \node[] at ($(ligne_1) + (-3.9cm, 0cm)$) {
    \begin{minipage}{6.3cm}
        \centering
        \begin{tikzpicture}
            % First image
            \node[anchor=south west,inner sep=0] (image1) at (0,0) {\includegraphics[width=2cm]{figures/clustering_agent_representation/pictures/mario_bros/2_clusters/bloc_pow_available/image_1.png}};
            ...
            % Second image
            \node[anchor=south west,inner sep=0] (image2) at (image1.south east) [xshift=0.05cm] {\includegraphics[width=2cm]{figures/clustering_agent_representation/pictures/mario_bros/2_clusters/bloc_pow_available/image_2.png}};
            \begin{scope}[shift={(image2.south west)}, x={(image2.south east)}, y={(image2.north west)}]
                \draw[red, line width=1pt] (0.4,0.275) rectangle (0.6,0.355);
            \end{scope}

            % Third image
            \node[anchor=south west,inner sep=0] (image3) at (image2.south east) [xshift=0.05cm] {\includegraphics[width=2cm]{figures/clustering_agent_representation/pictures/mario_bros/2_clusters/bloc_pow_available/image_3.png}};
    ...
    \caption{Effect of the number of clusters on the groupings identified by \gls{car} in the \MarioBrosName environment.}
