\begin{figure}[t]
    ...
    \begin{tikzpicture}
        ...
        \node[align=center] at ($(distribution_match.north) + (0, 1.25cm)$) {$\textcolor{myred}{\pi}^{\textcolor{myred}{'}}_{\textcolor{myred}{\Theta}}$ is trained to be as close as \\ possible of $\InitialPolicy$ for all $O$ in  order \\ to reproduce its behavior.};
        ...
        \node[align=center] at ($(box_2.south) + (0, -0.3cm)$) {\gls{ls} $\textcolor{myblue}{\mathcal{Z}}$ of $\textcolor{myred}{\pi}^{\textcolor{myred}{'}}_{\textcolor{myred}{\Theta}}$};
    \end{tikzpicture}
    }
