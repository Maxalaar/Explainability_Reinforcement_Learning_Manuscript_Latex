...
\begin{figure}[t]
    ...
    \node[below=0.75cm] at (0, -6) {
        ...
        \text{\ClusteringUniversalityName} = 1
        $}
    };

    \end{tikzpicture}
    }
    \caption{Illustration of \ClusteringUniversalityName{} in the ideal case where projections of the same observations are grouped within the same clusters across all surrogate policies.}
