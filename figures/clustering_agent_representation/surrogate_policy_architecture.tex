\begin{figure}[t]
    ...
    \caption{Architecture of the surrogate policy $\textcolor{mygreen}{\pi}$: the encoder maps the observation $O$ to the embedding $\textcolor{myblue}{\mathcal{Z}}$, from which the decoder reconstructs the action distribution parameters.}
