...
\begin{figure}[t]
    ...
    \caption{\gls{cu}, \gls{as}, and \gls{acu} averaged over the number of clusters $K \in [2,20]$, with respect to the depth of the analyzed layer, for each of the six environments. The dashed black line is a linear least-squares fit of the curve averaged over the six environments.}
