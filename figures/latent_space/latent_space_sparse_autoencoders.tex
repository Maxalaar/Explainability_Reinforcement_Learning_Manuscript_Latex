...
\caption{
  ...
  de type SAE. À gauche, les embeddings sont entremêlés dans l'espace
  latent initial. À droite, la représentation sparse aligne chaque concept
  sur un axe de feature dédié.
}
