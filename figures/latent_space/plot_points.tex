...
%    Using intermediate macros fails because they are shared and
%    overwritten by every subsequent \plotPoints call; by render
%    time every plot sees the last call's values.
%    \edef bakes the current color/size/opacity as literal strings
%    directly into the \addplot token list.
%
%  Example:
