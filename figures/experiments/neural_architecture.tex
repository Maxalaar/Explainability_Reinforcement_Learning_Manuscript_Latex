...
\providecommand{\NeuralArchBoxMarginYTop}{2cm}
\providecommand{\NeuralArchBoxMarginYBottom}{2cm}
...
\providecommand{\NeuralArchLabelAOffsetX}{0.1cm}
\providecommand{\NeuralArchLabelAOffsetY}{0.1cm}
