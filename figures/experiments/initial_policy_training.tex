...
\begin{axis}[
    ...
    width=\linewidth, height=\PolicyTrainingSubfigHeight,
    legend to name={policyTrainingLegend},
    ...
    \addlegendentry{\SpaceInvadersName}
